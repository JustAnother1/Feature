...
{
	public final static String PROJECT_FILE_CFG = "projectFile";
	...
	public boolean getFromFiles() 
	{
		...
		String fileName = cfg.getString(PROJECT_FILE_CFG);
		if(null == fileName)
		{
		...
		doc = FileGetter.getXmlFile(cfg.getString(PROJECT_PATH_CFG), fileName, report);
		if(null == doc)
		{
